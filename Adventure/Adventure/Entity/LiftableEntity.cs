...
namespace Adventure
{
    public abstract class LiftableEntity : Entity
    {
        ...
        public LiftableEntity(GameWorld game, Area area)
            : base(game, area)
        {
        ...
        private void doThrow()
        {
            ...
            if (area.GetCollisionAtCell(Area.ConvertPositionToCell(collisionPos)) == TileCollision.Impassable)
            {
