...
namespace Adventure
{
    public class PlayerSpriteHandler : SpriteHandler
    {
        ...
        const int WALK_ANIMATION_DELAY = 90;
        const int ATTACK_ANIMATION_DELAY = 14;
            ...
            : base(player)
        {
            ...
            spriteSetDict.Add(STILL_SPRITES_ID, spriteSet);
            ...
            spriteSetDict.Add(WALKING_SPRITES_ID, spriteSet);


            spriteSet = new SpriteSet();
            origin = new Vector2(16, 58);
            Sprite sprite = new Sprite("Sprites/Player/player_backward_sword2", player, origin, 6, ATTACK_ANIMATION_DELAY, 1);
            ...
            sprite = new Sprite("Sprites/Player/player_forward_sword2", player, origin, 6, ATTACK_ANIMATION_DELAY, 1);
            ...
            sprite = new Sprite("Sprites/Player/player_left_sword", player, origin, 6, ATTACK_ANIMATION_DELAY, 1);
            ...
            origin = new Vector2(16, 58);
            sprite = new Sprite("Sprites/Player/player_right_sword", player, origin, 6, ATTACK_ANIMATION_DELAY, 1);
            ...
            spriteSetDict.Add(ATTACKING_SPRITES_ID, spriteSet);
        }
